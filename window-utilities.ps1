...
.NOTES
   Author      : Vijay J
   GitHub      : https://github.com/yoyozaemon
    Version 0.0.1
#>
...
$WPFtweaksbutton.Add_Click({
    ...
    If ( $WPFEssTweaksOO.IsChecked -eq $true ) {
        ...
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/yoyozaemon/Windows-10-Debloat/master/ooshutup10.cfg" -Destination ooshutup10.cfg
